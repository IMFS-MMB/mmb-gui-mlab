function [residual, g1, g2] = US_YR13AL_static(y, x, params)
%
...
residual(18)= lhs-rhs;
lhs =y(9);
rhs =T120*(y(9)+y(9)*params(87)*params(85)+T126*y(7))+y(18);
residual(19)= lhs-rhs;
lhs =y(8);
...
residual(24)= lhs-rhs;
lhs =y(21);
rhs =y(21)*(1-params(92))+y(9)*params(92)+y(18)*params(44)*params(85)^2*params(92);
residual(25)= lhs-rhs;
lhs =y(15);
...
if nargout >= 2,
  ...
  g1(24,20)=(-1);
  g1(25,9)=(-params(92));
  g1(25,18)=(-(params(44)*params(85)^2*params(92)));
