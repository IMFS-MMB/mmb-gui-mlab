...
residual(18)= lhs-rhs;
lhs =y(31);
rhs =T127*(y(5)+params(87)*params(85)*y(65)+T135*y(29))+y(40);
residual(19)= lhs-rhs;
lhs =y(30);
...
residual(24)= lhs-rhs;
lhs =y(43);
rhs =y(14)*(1-params(92))+y(31)*params(92)+y(40)*params(44)*params(85)^2*params(92);
residual(25)= lhs-rhs;
lhs =y(37);
...
if nargout >= 2,
  ...
  g1(24,42)=(-1);
  g1(25,31)=(-params(92));
  g1(25,40)=(-(params(44)*params(85)^2*params(92)));
