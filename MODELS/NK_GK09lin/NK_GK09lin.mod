...
// This model file was implemented based on the previous working paper of the following reference.
...
gamma = 0.779;
gammap = 0.241;
kappa_pi = 1.5;  // in the published version, 2.043; in the working paper 
kappa_mc = 0.5/4;
rhoi = 0;
rhoa = 0.95;
rhoeps = 0.66;
