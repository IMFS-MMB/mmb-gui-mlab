...
varexo  EA_EPSRP EA_EPSTAUC EA_EPSTAUD EA_EPSTAUK EA_EPSTAUN 
  EA_EPSTAUWF EA_EPSTAUWH EA_EPSTR EA_EPSZ  
  US_EPSG US_EPSTAUC US_EPSTAUD US_EPSTAUK 
  US_EPSTAUN US_EPSTAUWF US_EPSTAUWH US_EPSTR US_EPSZ //EA_EPSR US_EPSR
...
(US_R^4-US_interest_EXOG^4)/US_interest_EXOG^4 =                          //*
           ...
           + cofintoutp*(US_Y/US_YBAR)                                    //*           
           + cofintoutpb1*(US_Y(-1)/US_YBAR)                              //* 
           + cofintoutpb2*(US_Y(-2)/US_YBAR)                              //* 
           + cofintoutpb3*(US_Y(-3)/US_YBAR)                              //* 
           + cofintoutpb4*(US_Y(-4)/US_YBAR)                              //* 
           + cofintoutpf1*(US_Y(+1)/US_YBAR)                              //* 
           + cofintoutpf2*(US_Y(+2)/US_YBAR)                              //* 
           + cofintoutpf3*(US_Y(+3)/US_YBAR)                              //* 
           + cofintoutpf4*(US_Y(+4)/US_YBAR);                            //*                                                                        //*
//**************************************************************************
