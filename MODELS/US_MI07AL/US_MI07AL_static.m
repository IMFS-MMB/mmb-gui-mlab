function [residual, g1, g2] = US_MI07AL_static(y, x, params)
%
...
residual(10)= lhs-rhs;
lhs =y(3);
rhs =params(38)*(y(4)*params(39)+y(5)*((1-params(35)*params(40))*params(36))^(-1))+params(35)*y(3)+y(7);
residual(11)= lhs-rhs;
lhs =y(3);
...
if nargout >= 2,
  ...
  g1(11,5)=(-(params(38)*((1-params(35)*params(40))*params(36))^(-1)));
  g1(11,7)=(-1);
  g1(12,2)=(-(1-params(37)));
  g1(12,3)=1;
