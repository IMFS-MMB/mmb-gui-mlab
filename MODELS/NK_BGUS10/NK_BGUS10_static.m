function [residual, g1, g2] = NK_BGUS10_static(y, x, params)
%
...
T214 = (1-params(48))/(1-params(48)*params(47));
T218 = params(48)*(1-params(47))/(1-params(48)*params(47));
T222 = params(47)*params(36)*params(48)/(1-params(48)*params(47));
lhs =y(16);
rhs =y(8)*4;
residual(1)= lhs-rhs;
lhs =y(17);
...
residual(10)= lhs-rhs;
lhs =y(3)*params(47);
rhs =y(6)-y(6)*(1-params(47))*(1-y(3));
residual(11)= lhs-rhs;
lhs =params(47)*y(9);
rhs =y(11)-y(11)*(1-params(47))*(1-y(9));
residual(12)= lhs-rhs;
lhs =y(4);
rhs =y(5)+y(6)*T214+y(6)*T218-y(3)*T222;
residual(13)= lhs-rhs;
lhs =y(10);
rhs =y(5)+y(11)*T214+y(11)*T218-y(9)*T222;
residual(14)= lhs-rhs;
lhs =y(4);
...
if nargout >= 2,
  ...
  g1(11,3)=params(47)-(-(y(6)*(-(1-params(47)))));
  g1(11,6)=(-(1-(1-params(47))*(1-y(3))));
  g1(12,9)=params(47)-(-(y(11)*(-(1-params(47)))));
  g1(12,11)=(-(1-(1-params(47))*(1-y(9))));
  g1(13,3)=T222;
  g1(13,4)=1;
  g1(13,5)=(-1);
  g1(13,6)=(-(T214+T218));
