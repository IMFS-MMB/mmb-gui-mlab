...
// Reference: Darracq Pariès, M., C. Kok, D. Rodriguez-Palenzuela. (2011). 
...
// The original model code has been provided by Matthieu Darracq Pariès.

// Last edited by: Marcus Jüppner, November 2016
