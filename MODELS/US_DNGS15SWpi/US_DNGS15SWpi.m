...
options_ = [];
M_.fname = 'US_DNGS15SWpi';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('US_DNGS15SWpi.log');
M_.exo_names = 'psi_b';
...
M_.param_names = char(M_.param_names, 'pist');
M_.param_names_tex = char(M_.param_names_tex, 'pist');
M_.param_names_long = char(M_.param_names_long, 'pist');
M_.exo_det_nbr = 0;
M_.exo_nbr = 8;
M_.endo_nbr = 64;
M_.param_nbr = 79;
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('US_DNGS15SWpi_static');
erase_compiled_function('US_DNGS15SWpi_dynamic');
...
make_ex_;
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (0.2241)^2;
M_.Sigma_e(2, 2) = (0.4305)^2;
M_.Sigma_e(3, 3) = (0.4629)^2;
M_.Sigma_e(4, 4) = (0.1489)^2;
M_.Sigma_e(5, 5) = (0.3004)^2;
M_.Sigma_e(6, 6) = (0)^2;
M_.Sigma_e(8, 8) = (2.9214)^2;
save('US_DNGS15SWpi_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('US_DNGS15SWpi_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('US_DNGS15SWpi_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('US_DNGS15SWpi_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('US_DNGS15SWpi_results.mat', 'estimation_info', '-append');
end
