...
options_ = [];
M_.fname = 'US_DNGS15SW';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('US_DNGS15SW.log');
M_.exo_names = 'psi_b';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('US_DNGS15SW_static');
erase_compiled_function('US_DNGS15SW_dynamic');
...
make_ex_;
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (0.2174)^2;
M_.Sigma_e(2, 2) = (0.4177)^2;
M_.Sigma_e(3, 3) = (0.4576)^2;
M_.Sigma_e(4, 4) = (0.1417)^2;
M_.Sigma_e(5, 5) = (0.2712)^2;
M_.Sigma_e(6, 6) = (0)^2;
M_.Sigma_e(8, 8) = (2.928)^2;
save('US_DNGS15SW_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('US_DNGS15SW_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('US_DNGS15SW_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('US_DNGS15SW_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('US_DNGS15SW_results.mat', 'estimation_info', '-append');
end
