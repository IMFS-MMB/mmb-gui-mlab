function [residual, g1, g2] = NK_CW09_static(y, x, params)
%
...
T200 = y(25)^(-1);
T205 = y(17)^(-params(42));
T206 = y(24)*params(40)*(1+params(41))*params(49)*y(18)*T200*T205;
...
T288 = (1-params(44)*y(5)^(params(43)-1))/(1-params(44));
T321 = 1/params(42);
...
T589 = 1/y(5);
T602 = 1/params(47)*getPowerDeriv(y(3)/params(47),T321,1);
T628 = 1/params(48)*getPowerDeriv(y(4)/params(48),T321,1);
T668 = (-(params(44)*getPowerDeriv(y(5),params(43)-1,1)))/(1-params(44));
T674 = getPowerDeriv(y(7)/y(21),1+params(41),1);
T685 = getPowerDeriv(y(9)/y(8),(params(43)-1)/(1+params(41)*params(43)),1);
lhs =y(51);
rhs =y(26)*4;
residual(1)= lhs-rhs;
lhs =y(52);
rhs =y(29)+y(29)+y(66)+y(67);
residual(2)= lhs-rhs;
lhs =y(53);
rhs =4*y(29);
residual(3)= lhs-rhs;
...
residual(12) = y(7)*y(24)*(1-y(19))+params(35)*params(44)*y(5)^(params(43)-1)*y(9)-y(9);
residual(13) = params(38)*(1-params(38))*y(23)-params(38)*y(22)+params(37)*(params(38)*y(22)+(1+y(20))*y(11))*T245-y(11)*(1+y(20)*params(38));
residual(14) = params(38)*y(16)*T257+(1-params(38))*y(15)*T263+T274*y(11)^params(50)+y(12)-y(7);
...
residual(17) = 1+(1+params(51))*y(13)*y(11)^params(51)+params(50)*T274*y(11)^(params(50)-1)-(1+y(20));
lhs =y(23);
...
residual(42)= lhs-rhs;
lhs =y(13);
rhs =params(79)+y(37)/((1+params(51))*params(93)^params(51));
residual(43)= lhs-rhs;
lhs =y(15)/params(78);
rhs =exp(y(38));
residual(44)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(6,56)=1;
  g1(7,51)=1-params(1);
  g1(7,53)=(-(params(10)+params(6)+params(5)));
  g1(7,54)=(-(params(19)+params(15)+params(14)));
  g1(7,55)=(-(params(28)+params(24)+params(23)));
  g1(7,57)=(-params(11));
  g1(7,58)=(-params(12));
  g1(7,59)=(-params(13));
  g1(7,60)=(-params(20));
  ...
  g1(9,3)=(1+y(1))*(1+y(20))*params(35)*(params(37)+(1-params(37))*params(38))*T589-1;
  g1(9,4)=(1+y(1))*(1+y(20))*params(35)*(1-params(37))*(1-params(38))*T589;
  ...
  g1(10,3)=(1+y(1))*params(35)*(1-params(37))*params(38)*T589;
  g1(10,4)=(1+y(1))*params(35)*(params(37)+(1-params(37))*(1-params(38)))*T589-1;
  g1(10,5)=(1+y(1))*params(35)*((1-params(37))*params(38)*(-y(3))/(y(5)*y(5))+(params(37)+(1-params(37))*(1-params(38)))*(-y(4))/(y(5)*y(5)));
  g1(11,5)=y(8)*params(35)*params(44)*getPowerDeriv(y(5),(1+params(41))*params(43),1);
  g1(11,7)=T206*1/y(21)*T674;
  g1(11,8)=params(35)*params(44)*T216-1;
  g1(11,17)=T210*y(24)*params(40)*(1+params(41))*params(49)*y(18)*T200*getPowerDeriv(y(17),(-params(42)),1);
  g1(11,18)=T210*T205*y(24)*params(40)*(1+params(41))*params(49)*T200;
  g1(11,21)=T206*T674*(-y(7))/(y(21)*y(21));
  ...
  g1(12,5)=y(9)*params(35)*params(44)*getPowerDeriv(y(5),params(43)-1,1);
  g1(12,7)=y(24)*(1-y(19));
  g1(12,9)=params(35)*params(44)*y(5)^(params(43)-1)-1;
  g1(12,19)=y(7)*(-y(24));
  g1(12,24)=y(7)*(1-y(19));
  g1(13,1)=params(37)*(params(38)*y(22)+(1+y(20))*y(11))*T589;
  ...
  g1(14,3)=params(38)*y(16)*getPowerDeriv(y(3),(-params(45)),1);
  g1(14,4)=(1-params(38))*y(15)*getPowerDeriv(y(4),(-params(46)),1);
  g1(14,7)=(-1);
  g1(14,11)=T274*getPowerDeriv(y(11),params(50),1);
  g1(14,12)=1;
  g1(14,15)=(1-params(38))*T263;
  g1(14,16)=params(38)*T257;
  g1(14,35)=T270*y(11)^params(50);
  g1(15,5)=params(44)*y(10)*getPowerDeriv(y(5),(1+params(41))*params(43),1)+(1-params(44))*T668*getPowerDeriv(T288,(1+params(41))*params(43)/(params(43)-1),1);
  g1(15,10)=params(44)*T216-1;
  g1(16,5)=T668;
  g1(16,8)=(-((-y(9))/(y(8)*y(8))*T685));
  g1(16,9)=(-(T685*1/y(8)));
  g1(17,11)=(1+params(51))*y(13)*getPowerDeriv(y(11),params(51),1)+params(50)*T274*getPowerDeriv(y(11),params(50)-1,1);
  g1(17,13)=(1+params(51))*y(11)^params(51);
  g1(17,20)=(-1);
  g1(17,35)=y(11)^(params(50)-1)*params(50)*T270;
  g1(18,3)=(-(y(16)*getPowerDeriv(y(3),(-params(45)),1)-y(10)*T210*T205*y(18)*T331*T602));
  g1(18,4)=(-((-(y(15)*getPowerDeriv(y(4),(-params(46)),1)))-y(10)*T210*T205*y(18)*T331*(-T628)));
  g1(18,7)=y(10)*T205*y(18)*(T322-T325)*T331*1/y(21)*T674;
  g1(18,10)=T210*T205*y(18)*(T322-T325)*T331;
  g1(18,15)=T263;
  g1(18,16)=(-T257);
  g1(18,17)=y(10)*T210*y(18)*(T322-T325)*T331*getPowerDeriv(y(17),(-params(42)),1);
  g1(18,18)=y(10)*T210*T205*(T322-T325)*T331;
  g1(18,21)=y(10)*T205*y(18)*(T322-T325)*T331*T674*(-y(7))/(y(21)*y(21));
  g1(18,23)=1;
  g1(18,25)=y(10)*T210*T205*y(18)*(T322-T325)*1/params(49)*getPowerDeriv(y(25)/params(49),(-(1+params(42)))/params(42),1);
  g1(19,3)=(-(params(49)*params(38)*T602*getPowerDeriv(params(38)*T322+(1-params(38))*T325,params(42),1)));
  g1(19,4)=(-(params(49)*getPowerDeriv(params(38)*T322+(1-params(38))*T325,params(42),1)*(1-params(38))*T628));
  g1(19,25)=1;
  g1(20,3)=(-params(38));
  g1(20,4)=(-(1-params(38)));
  g1(20,24)=1;
  ...
  g1(42,36)=(-params(67));
  g1(43,13)=1;
  g1(43,37)=(-(1/((1+params(51))*params(93)^params(51))));
