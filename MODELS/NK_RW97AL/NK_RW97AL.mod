...
// Last edited: 13/06/26 by V. Audzei (Adaptive Learning) based on the code by S. Schmidt
...
//**************************************************************************
// Modelbase Variables                                                   //*    
   interest inflation inflationq inflationql inflationql2 inflationqls outputgap output fispol;                //*
//**************************************************************************
...
//states_short = {'u','g','pi','inflationq'};
//states_short = {'g','interest','inflationq'};
AL_Info.states_short = {'g','interest'};
AL_Info.states_long  = {'g','inflationq','inflationql','inflationql2','interest'};
//states_long  = {'g','inflationq','inflationqls'};
//states_long  = {'g','inflationq','inflationqls'};
