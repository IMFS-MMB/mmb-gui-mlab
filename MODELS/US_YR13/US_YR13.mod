...
//forwards = {'c','pinf','inflationq','w','lab','inve', 'rk', 'pk'};
//states_long  = {'c', 'ec', 'pk','inve','kp','inflationq','inflationqls','nw','pinf','w','a','b','g','qs','spinf','sw'};
//states_short = {'c', 'ec', 'pk','inve','kp','inflationq','nw','pinf','w','a','b','g','qs','spinf','sw'};
