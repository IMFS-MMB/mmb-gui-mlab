function [residual, g1, g2] = NK_RW06_static(y, x, params)
%
...
residual(4)= lhs-rhs;
lhs =y(4);
rhs =params(32)*x(2)+params(22)*y(13)+params(21)*y(12)+params(20)*y(11)+y(7)*params(19)+params(18)*y(18)+params(17)*y(17)+params(16)*y(16)+y(7)*params(15)+y(7)*params(14)+params(13)*y(10)+params(12)*y(9)+params(11)*y(8)+y(6)*params(10)+y(6)*params(6)+y(6)*params(5)+y(4)*params(1)+params(2)*y(19)+params(3)*y(20)+params(4)*y(21)+params(7)*y(22)+params(8)*y(23)+params(9)*y(24);
residual(5)= lhs-rhs;
lhs =y(1);
...
if nargout >= 2,
  ...
  g1(6,2)=(-(1/params(35)));
  g1(6,3)=1/params(35);
  g1(7,1)=(-(params(39)*(params(35)+params(36))));
  g1(7,2)=1-params(37);
  g1(7,3)=(-params(39));
  g1(8,6)=(-1);
  g1(8,8)=1;
