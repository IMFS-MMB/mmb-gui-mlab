function [residual, g1, g2] = NK_MM10_static(y, x, params)
%
...
T471 = params(35)*params(44)*y(38)^(1+params(43)*params(39))+T465*(y(12)*y(13))^(params(43)*(1+params(39)));
T479 = y(12)^(params(43)-1);
T481 = params(35)*params(44)*y(39)^(1+params(43)*params(39))+y(18)*y(4)*y(13)^params(43)*T479;
T484 = y(12)^(1-params(43));
T485 = y(13)^(1-params(43));
T509 = y(12)^params(50);
T515 = y(12)^(params(50)-1);
T532 = y(4)^params(55);
T535 = T256*T252*params(54)*y(23)*exp(y(40))*y(30)^(params(54)-1)*T532;
T538 = y(30)^params(54);
T540 = y(4)^(params(55)-1);
T573 = params(61)-params(63)/params(62)-params(59)/(params(62)*y(10));
T574 = params(58)*y(10)*T573;
T704 = getPowerDeriv(T471,T452,1);
T709 = getPowerDeriv(T481,T452,1);
T712 = getPowerDeriv(y(4),params(55),1);
T786 = params(58)*T573+params(58)*y(10)*(-((-(params(59)*params(62)))/(params(62)*y(10)*params(62)*y(10))));
T888 = y(22)/y(20)*y(22)/y(20);
T944 = getPowerDeriv(y(30),params(54),1);
T1028 = getPowerDeriv(y(48),params(55),1);
T1085 = params(58)*T310+y(54)*params(58)*(-((-(params(59)*params(62)))/(y(54)*params(62)*y(54)*params(62))));
T1173 = getPowerDeriv(y(70),params(54),1);
lhs =y(77);
...
residual(5)= lhs-rhs;
lhs =y(77);
rhs =params(32)*x(2)+params(31)*y(90)+params(30)*y(89)+params(29)*y(88)+y(80)*params(28)+params(27)*y(95)+params(26)*y(94)+params(25)*y(93)+y(80)*params(24)+y(80)*params(23)+params(22)*y(87)+params(21)*y(86)+params(20)*y(85)+y(81)*params(19)+params(18)*y(98)+params(17)*y(97)+params(16)*y(96)+y(81)*params(15)+y(81)*params(14)+params(13)*y(84)+params(12)*y(83)+params(11)*y(82)+y(79)*params(10)+y(79)*params(6)+y(79)*params(5)+y(77)*params(1)+params(2)*y(99)+params(3)*y(100)+params(4)*y(101)+y(91)*params(7)+y(92)*params(8)+params(9)*y(102);
residual(6)= lhs-rhs;
lhs =y(64);
rhs =(y(16));
residual(7)= lhs-rhs;
...
residual(11)= lhs-rhs;
lhs =y(60)^(1-params(43))*y(57)^(1-params(43));
...
residual(51)= lhs-rhs;
lhs =y(12)^(1-params(50));
rhs =(1-params(51))*y(34)^(1-params(50))+params(51)*y(12)^(1-params(50));
residual(52)= lhs-rhs;
lhs =y(11);
rhs =T535;
residual(53)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,81)=1;
  g1(6,77)=1-params(1);
  g1(6,79)=(-(params(10)+params(6)+params(5)));
  g1(6,80)=(-(params(28)+params(24)+params(23)));
  g1(6,81)=(-(params(19)+params(15)+params(14)));
  g1(6,82)=(-params(11));
  g1(6,83)=(-params(12));
  g1(6,84)=(-params(13));
  g1(6,85)=(-params(20));
  ...
  g1(12,57)=y(60)^(1-params(43))*getPowerDeriv(y(57),1-params(43),1);
  g1(12,60)=y(57)^(1-params(43))*getPowerDeriv(y(60),1-params(43),1);
  g1(12,76)=(-(params(47)*getPowerDeriv(y(76),1-params(43),1)));
  g1(13,48)=(-(T231*T229*T225*getPowerDeriv(y(48),params(39),1)));
  g1(13,57)=(-(T231*T225*y(48)^params(39)*getPowerDeriv(y(57),params(43)*params(39),1)));
  g1(13,60)=(-(T230*getPowerDeriv(y(60),1+params(43)*params(39),1)));
  g1(13,62)=(-(T231*T229*y(48)^params(39)*(-(params(43)*params(38)/(params(43)-1)))/(y(62)*y(62))));
  g1(13,76)=getPowerDeriv(y(76),1+params(43)*params(39),1);
  g1(14,23)=(-1);
  g1(14,65)=1;
  g1(15,40)=(-T257);
  g1(15,48)=(-(T256*T252*y(65)*exp(y(40))*params(54)*y(70)^(params(54)-1)*T1028));
  g1(15,55)=1;
  g1(15,65)=(-(T256*T252*T248*y(70)^(params(54)-1)*exp(y(40))*params(54)));
  ...
  g1(16,70)=(-(T256*T252*T263*y(65)*exp(y(40))*params(55)*T1173));
  g1(17,40)=(-T275);
  g1(17,48)=(-(T256*T273*T260*y(65)*exp(y(40))*params(56)*T1028));
  g1(17,58)=1;
  g1(17,65)=(-(T256*T273*T248*T260*exp(y(40))*params(56)));
  g1(17,70)=(-(T256*T273*T248*y(65)*exp(y(40))*params(56)*T1173));
  g1(18,40)=(-T284);
  g1(18,48)=(-(T283*T252*T260*y(65)*exp(y(40))*params(57)*T1028));
  g1(18,59)=1;
  g1(18,65)=(-(T283*T252*T248*T260*exp(y(40))*params(57)));
  g1(18,70)=(-(T283*T252*T248*y(65)*exp(y(40))*params(57)*T1173));
  g1(19,50)=1;
  g1(19,51)=(-(1/y(53)));
  g1(19,52)=(-(1/y(53)));
  ...
  g1(31,48)=(-(T256*T252*exp(y(40))*T260*T1028));
  g1(31,49)=1;
  g1(31,70)=(-(T256*T252*T248*exp(y(40))*T1173));
  ...
  g1(40,16)=(-y(18));
  g1(40,18)=(-(y(16)-1));
  g1(40,20)=(-(params(37)*(-y(22))/(y(20)*y(20))))/T888;
  g1(40,22)=(-(params(37)*1/y(20)))/T888;
  g1(41,11)=1;
  g1(41,29)=(-params(41));
  ...
  g1(46,4)=(-((y(12)*y(13))^(params(43)*(1+params(39)))*getPowerDeriv(y(4),1+params(39),1)*T704));
  g1(46,12)=(-(T704*T465*y(13)*getPowerDeriv(y(12)*y(13),params(43)*(1+params(39)),1)));
  g1(46,13)=(-(T704*T465*y(12)*getPowerDeriv(y(12)*y(13),params(43)*(1+params(39)),1)));
  g1(46,38)=1-T704*params(35)*params(44)*getPowerDeriv(y(38),1+params(43)*params(39),1);
  g1(47,4)=(-(T479*y(18)*y(13)^params(43)*T709));
  g1(47,12)=(-(T709*y(18)*y(4)*y(13)^params(43)*getPowerDeriv(y(12),params(43)-1,1)));
  g1(47,13)=(-(T709*T479*y(18)*y(4)*getPowerDeriv(y(13),params(43),1)));
  g1(47,18)=(-(T709*T479*y(4)*y(13)^params(43)));
  g1(47,39)=1-T709*params(35)*params(44)*getPowerDeriv(y(39),1+params(43)*params(39),1);
  g1(48,12)=T485*getPowerDeriv(y(12),1-params(43),1)-T485*params(44)*getPowerDeriv(y(12),1-params(43),1);
  g1(48,13)=T484*getPowerDeriv(y(13),1-params(43),1)-params(44)*T484*getPowerDeriv(y(13),1-params(43),1);
  ...
  g1(52,12)=getPowerDeriv(y(12),1-params(50),1)-params(51)*getPowerDeriv(y(12),1-params(50),1);
  g1(52,34)=(-((1-params(51))*getPowerDeriv(y(34),1-params(50),1)));
  g1(53,4)=(-(T256*T252*params(54)*y(23)*exp(y(40))*y(30)^(params(54)-1)*T712));
  g1(53,11)=1;
  g1(53,23)=(-(T256*T252*T532*y(30)^(params(54)-1)*exp(y(40))*params(54)));
  ...
  g1(54,30)=(-(T256*T252*T540*params(55)*y(23)*exp(y(40))*T944));
  g1(54,40)=(-(T256*T252*params(55)*y(23)*exp(y(40))*T538*T540));
  g1(55,4)=(-(T256*T273*T538*params(56)*y(23)*exp(y(40))*T712));
  g1(55,14)=1;
  g1(55,23)=(-(T256*T273*T532*T538*exp(y(40))*params(56)));
  g1(55,30)=(-(T256*T273*T532*params(56)*y(23)*exp(y(40))*T944));
  g1(55,40)=(-(T256*T273*T532*T538*params(56)*y(23)*exp(y(40))));
  g1(56,4)=(-(T283*T252*T538*params(57)*y(23)*exp(y(40))*T712));
  g1(56,15)=1;
  g1(56,23)=(-(T283*T252*T532*T538*exp(y(40))*params(57)));
  g1(56,30)=(-(T283*T252*T532*params(57)*y(23)*exp(y(40))*T944));
  ...
  g1(69,4)=(-(T256*T252*exp(y(40))*T538*T712));
  g1(69,5)=1;
  g1(69,30)=(-(T256*T252*T532*exp(y(40))*T944));
